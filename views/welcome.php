        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 ml-auto">
                    <p class="lead text-justify">Codingox is a free PHP Framework created by Mind You Infotech. The download includes the complete source files and documentation.</p>
                </div>
