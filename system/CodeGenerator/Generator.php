...
<head>
    ...
    <link href="<?= APP_URL.'/'.APP_PATH; ?>bootstrap/css/main.css" rel="stylesheet">
    <script src="<?= APP_URL.'/'.APP_PATH; ?>bootstrap/js/jquery.js"></script>
</head>
                            ...
                            <div class="col-lg-8 col-md-10" id="form-fields">
                                <div class="form-group field-generator-controllerclass required">
                                    <label class="control-label help"
                                        title="This is the name of the controller class to be generated."
                                        for="generator-controllerclass">Controller Class</label>
                                    <input type="hidden" name="type" value="controller">
                                    <input type="text" id="generator-controllerclass" class="form-control"
                                        name="controller" aria-required="true">
                                </div>
                                <div class="form-group field-generator-actions">
                                    <label class="control-label help"
                                        title="Provide one or multiple action IDs to generate empty action method(s) in the controller. Separate multiple action IDs with commas or spaces. Action IDs should be in lower case."
                                        for="generator-actions">Action IDs</label>
                                    <input type="text" id="generator-actions" class="form-control" name="action"
                                        value="index,about">
                                </div>
                                <div class="form-group field-generator-viewpath">
                                    <label class="control-label help" data-toggle="popover"
                                        title="Specify the directory for storing the view scripts for the controller."
                                        data-placement="right" for="generator-viewpath">View Path</label>
                                    <input type="text" id="generator-viewpath" value="views/" class="form-control" name="viewPath">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-10" id="form-fields">
                                <div class="form-group field-generator-viewname required">
                                    <label class="control-label help"
                                        title="This is the view name with respect to the view path."
                                        for="generator-viewname">View Name</label>
                                    <input type="hidden" name="type" value="form">
                                    <input type="text" id="generator-viewname" class="form-control" name="viewName"
                                        aria-required="true" aria-invalid="true">
                                </div>
                                <div class="form-group field-generator-modelclass required">
                                    <label class="control-label help"
                                        title="This is the form field for collecting the form input."
                                        for="generator-modelclass">Form Field</label>
                                    <input type="text" id="generator-modelclass" value="name,number" class="form-control" name="field"
                                        aria-required="true">
                                </div>
                                <div class="form-group sticky field-generator-viewpath required">
                                    <label class="control-label help"
                                        title="This is the root view path to keep the generated view files. You may provide either a directory or a path."
                                        for="generator-viewpath">View Path</label>
                                    <input type="text" id="generator-viewpath" class="form-control" name="viewPath"
                                        value="views/" aria-required="true">
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary" name="preview">Generate</button>
                                </div>
    ...
    <footer class="footer border-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-6">
                    <p class="text-right">Powered by <a href="http://framework.upgradeads.in"
                            rel="external">CodingOx</a></p>
                </div>
            </div>
        </div>
    </footer>
